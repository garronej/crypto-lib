...
var salt = Buffer.from((new Array(16)).fill("ff").join(""), "hex");
var password = "my super secure password";
var log = (function () {
    var acc = "";
    var f = function (str) {
        acc += str + "\n";
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var _i, _a, iterations, start, result, _b, _c, _d, _e, error_1;
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                log(JSON.stringify({ password: password, "salt": toBuffer_1.toBuffer(salt).toString("hex") }));
                _i = 0, _a = [100000, 200000, 900000];
                _f.label = 1;
            case 1:
            ...
            case 2:
                _f.trys.push([2, 5, , 6]);
                _b = Uint8Array.bind;
                _d = (_c = window.crypto.subtle).deriveBits;
                _e = [{
                        "name": "PBKDF2",
                        salt: salt,
            ...
            case 6:
                ...
                log(toBuffer_1.toBuffer(result).toString("hex"));
                log.alert();
                _f.label = 7;
            case 7:
                _i++;
...
},{"../sync/utils/toBuffer":1,"buffer":4}],3:[function(require,module,exports){
'use strict'
